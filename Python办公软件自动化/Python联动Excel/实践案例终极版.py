...
# 加载Excel文件
workbook = openpyxl.load_workbook('薪水明细.xlsx')
...
for i in range(4,9):
    ...
    write_sheet.row_dimensions[1].height = 30
    ...
    for cell in three_rows:
        ...
        cell.border = border
    write_sheet.row_dimensions[3].height = 46.8
    ...
    write_workbook.save('personal salary/'+write_sheet['B4'].value+'.xlsx')
